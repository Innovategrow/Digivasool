...
const SEED_BORROWERS = [
  { id: 'b1', name: 'Rajan Kumar',    phone: '9876543210', address: '12 3rd Street, Gandhipuram', zone: 'Gandhipuram', guarantor: 'Suresh K', rating: 4, kyc: 'verified', photo: null, loans: ['l1', 'l4'] },
  { id: 'b2', name: 'Meena Devi',     phone: '8765432109', address: '45 Cross Cut Rd, Gandhipuram', zone: 'Gandhipuram', guarantor: 'Ramesh M', rating: 5, kyc: 'verified', photo: null, loans: ['l2'] },
  { id: 'b3', name: 'Selvam P',       phone: '7654321098', address: '7 Nehru Nagar, Peelamedu', zone: 'Peelamedu', guarantor: 'Kavitha S', rating: 3, kyc: 'pending', photo: null, loans: ['l3'] },
  { id: 'b4', name: 'Priya Lakshmi',  phone: '6543210987', address: '89 Avinashi Rd, Peelamedu', zone: 'Peelamedu', guarantor: 'Venkat P', rating: 5, kyc: 'verified', photo: null, loans: ['l5'] },
  { id: 'b5', name: 'Murugan S',      phone: '9988776655', address: '23 DB Road, RS Puram', zone: 'RS Puram', guarantor: 'Arjun M', rating: 2, kyc: 'rejected', photo: null, loans: ['l6'] },
  { id: 'b6', name: 'Anitha R',       phone: '9876541230', address: '56 Saibaba Colony Main Rd', zone: 'Saibaba Colony', guarantor: 'Lakshmi A', rating: 4, kyc: 'verified', photo: null, loans: ['l7'] },
  { id: 'b7', name: 'Karthik V',      phone: '8877665544', address: '34 Trichy Rd, Singanallur', zone: 'Singanallur', guarantor: 'Suresh V', rating: 3, kyc: 'pending', photo: null, loans: [] },
  { id: 'b8', name: 'Saranya M',      phone: '7766554433', address: '11 SITRA, Avinashi Road', zone: 'Avinashi Road', guarantor: 'Kumar M', rating: 5, kyc: 'verified', photo: null, loans: ['l8'] },
  { id: 'b9', name: 'Vijay C',        phone: '6655443322', address: '78 Kalapatti, Saravanampatti', zone: 'Saravanampatti', guarantor: 'Devi C', rating: 4, kyc: 'verified', photo: null, loans: ['l9'] },
  { id: 'b10', name: 'Deepa N',       phone: '9911223344', address: '45 Ukkadam Main Rd', zone: 'Ukkadam', guarantor: 'Nair D', rating: 3, kyc: 'pending', photo: null, loans: ['l10'] },
];
